...
//
//    // ¬се строки, начинающиес€ с prefix, больше или равны строке "<prefix>"
//    auto left = lower_bound(range_begin, range_end, prefix);
//
//    // —оставим строку, котора€ в рамках буквенных строк €вл€етс€
//    // точной верхней гранью множества строк, начинающихс€ с prefix
//    string upper_bound = prefix;
//    ++upper_bound[upper_bound.size() - 1];
//
//    // ѕервое встреченное слово, не меньшее upper_bound,
//    // об€зательно €вл€етс€ концом полуинтервала
